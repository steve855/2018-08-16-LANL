	...
	<li>Enable the Windows Subsystem for Linux
	  <ol>
	    ...
	    <li> In the Powershell enter the following command:
	      <pre style="border-radius: 15px; background-color: #0000FF; color: white"><code style="white-space: nowrap">
	...
	<li> Open the "Ubuntu" application
	  <ol>
	    ...
	    <li>A black bash window will appear with the message
	      <pre style="border-radius: 15px; background-color: black; color: white"><code style="white-space: nowrap">
